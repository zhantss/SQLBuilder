...
export const option_exp_select_group = "选择来源表"
export const option_exp_select_db = "选择字段"
export const option_exp_on_auto_search = "快速查找"
export const option_exp_custom_text_hint = "自定义内容"
export const option_exp_parentheses_node_text = "(.......)"
...
export const result_sql_save_close_window = "关闭"
export const result_sql_save_close_window_tip = "您确定要关闭本页?"
...
export const sync_dialog_builder = "模型处理中，请稍候..."
export const sync_dialog_builder_error = "模型处理失败，请重试或联系管理员"